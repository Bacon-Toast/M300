...
| 8 | `iam` should NOT be able to ping `db` on port `3306` | `nc -vz 192.168.11.100 3306` | `nc: connect to 192.168.11.100 port 3306 (tcp) failed: Connection timed out` | `nc: connect to 192.168.11.100 port 3306 (tcp) failed: Connection timed out` | Y |
